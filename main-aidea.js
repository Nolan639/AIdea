...
class AIToolDirectory {
    ...
    renderFeaturedTools() {
        ...
        featuredContainer.innerHTML = featuredTools.map(tool => this.createToolCard(tool, true)).join('');
            ...
            <div class="tool-card animate-fade-in-up" data-tool-id="${tool.id}">
                ...
                <div class="tool-header">
                    ...
                    <div class="tool-actions">
                        <button class="tool-action-btn favorite-btn ${isFavorite ? 'active' : ''}" data-tool-id="${tool.id}" title="Add to favorites">
                            <i class="fas fa-heart"></i>
                        </button>
                        <button class="tool-action-btn compare-btn ${isInComparison ? 'active' : ''}" data-tool-id="${tool.id}" title="Add to comparison">
                            <i class="fas fa-balance-scale"></i>
                        </button>
                        <button class="tool-action-btn info-btn" data-tool-id="${tool.id}" title="More info">
                ...
                <div class="tool-footer">
                    ...
                    <a href="${tool.websiteUrl}" target="_blank" class="tool-cta" onclick="event.stopPropagation();">
            ...
            <table class="comparison-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        ${compareTools.map(tool => `<td>${tool.features.slice(0, 3).join(', ')}</td>`).join('')}
                    </tr>
                    <tr>
                        <td><strong>Website</strong></td>
                        ${compareTools.map(tool => `<td><a href="${tool.websiteUrl}" target="_blank">Visit</a></td>`).join('')}
                    </tr>
                </tbody>
            </table>
        `;
